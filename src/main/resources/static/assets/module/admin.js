layui.define(["layer"], function (f) {
    ...
    var m = {
        version: "314", defaultTheme: "theme-admin", tableName: "easyweb", flexible: function (n) {
            ...
            return n
        }, layerData: {}, getLayerData: function (n, o) {
            if (n == undefined) {
    ...
    m.events = {
        flexible: function () {
            ...
            m.strToWin(h(this).data("window")).layui.admin.open({
                ...
                area: ["360px", "287px"],
                shade: 0,
                content: n ? n : "/tpl-user-information"
            })
        }, reset_user: function() {
            var n = h(this).data("url");
            m.strToWin(h(this).data("window")).layui.admin.open({
